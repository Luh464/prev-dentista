...
$rotas = [
    ...
    // Configurações do sistema (proprietário)
    'configuracao.taxas'           => ['ConfiguracaoController', 'taxasCartao',       ['proprietario']],
    'configuracao.taxas.salvar'    => ['ConfiguracaoController', 'salvarTaxa',        ['proprietario']],
    'configuracao.taxas.atualizar' => ['ConfiguracaoController', 'atualizarTaxa',     ['proprietario']],
    'configuracao.taxas.excluir'   => ['ConfiguracaoController', 'excluirTaxa',       ['proprietario']],
    'configuracao.taxas.ajax'      => ['ConfiguracaoController', 'buscarTaxaAjax',    null],
    'configuracao.comissoes'         => ['ConfiguracaoController', 'regrasComissao',  ['proprietario']],
    'configuracao.comissoes.salvar'  => ['ConfiguracaoController', 'salvarRegra',     ['proprietario']],
    'configuracao.comissoes.excluir' => ['ConfiguracaoController', 'excluirRegra',    ['proprietario']],
